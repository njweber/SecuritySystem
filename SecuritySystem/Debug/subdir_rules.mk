...
LCD.obj: ../LCD.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"C:/ti/CCS/ccsv8/tools/compiler/ti-cgt-msp430_18.12.1.LTS/bin/cl430" -vmspx --data_model=restricted --use_hw_mpy=F5 --include_path="C:/ti/CCS/ccsv8/ccs_base/msp430/include" --include_path="C:/Users/Nate/Desktop/School/Junior 2018-2019/ECE422/Final Project" --include_path="C:/ti/CCS/ccsv8/tools/compiler/ti-cgt-msp430_18.12.1.LTS/include" --advice:power=all --advice:hw_config=all --define=__MSP430FR6989__ --define=_MPU_ENABLE -g --printf_support=minimal --diag_warning=225 --diag_wrap=off --display_error_number --silicon_errata=CPU21 --silicon_errata=CPU22 --silicon_errata=CPU40 --preproc_with_compile --preproc_dependency="LCD.d_raw" $(GEN_OPTS__FLAG) "$<"
